"""Multi-GRU hyperparameter optimization calculations."""
...
from .modules.models import build_gru_model
...
def run_optuna_gru_standard(
    ...
    *,
    ...
    if runtime.single_output:
        raise ValueError("Multi-GRU requires multi-output runtime semantics")
    study = optuna.create_study(
        study_name="multi-gru-hpo",
        direction="maximize",
