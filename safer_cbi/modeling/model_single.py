"""Single-ATT hyperparameter optimization calculations."""
...
def run_optuna_single_standard(
    ...
    *,
    ...
    """Return a completed five-fold AUROC HPO study."""
    if not runtime.single_output:
        raise ValueError("Single-ATT requires single-output runtime semantics")
    study = optuna.create_study(
        study_name=f"single-attention-{task_label}-hpo",
        direction="maximize",
